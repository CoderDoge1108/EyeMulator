...
AUTH_TOKEN = "PLACEHOLDER" # Replace with your token if needed
...
def compute_metrics(p: EvalPrediction):
    try:
        ...
        logging.error(f"Could not compute perplexity: {e}")
        return {}
...
def main():
    ...
    logging.info(f"Train dataset size: {train_dataset_size}, Steps per epoch: {steps_per_epoch}")
    ...
    logging.info("Starting baseline model training (debug mode)...")
    trainer.train()
