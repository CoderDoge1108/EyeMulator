...
# ─────────────────────────────────────────────────────────────────────────────
# ❺ Resilient OpenAI call with expo + jitter back-off
# ─────────────────────────────────────────────────────────────────────────────
TRANSIENT_ERRORS = (
    RateLimitError,
    APITimeoutError,
...
async def label_async(task: str, rec: dict) -> str:
    async with _SEM:                                   # concurrency limit
...
# ─────────────────────────────────────────────────────────────────────────────
# ❼ Phase 1 – generate canonical labels
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# ❽ Phase 2 – apply labels to every result file
# ─────────────────────────────────────────────────────────────────────────────
...
async def main(root: str = "."):
    root_path = Path(root)
    logging.info("🚀 llm_group_labelling starting …")

    # canonical folder = first model folder that exists
